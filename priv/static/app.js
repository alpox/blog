...
var _user$project$Article_Types$Retrieve = function (a) {
	return {ctor: 'Retrieve', _0: a};
};

var _user$project$Dashboard_Types$initialModel = {
	posts: {ctor: '[]'},
	error: _elm_lang$core$Maybe$Nothing
};
var _user$project$Dashboard_Types$Model = F2(
	function (a, b) {
		return {posts: a, error: b};
	});
var _user$project$Dashboard_Types$Retrieve = function (a) {
	return {ctor: 'Retrieve', _0: a};
};
...
var _user$project$App_Types$PostsRoute = {ctor: 'PostsRoute'};

var _user$project$App_Routes$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$App_Types$PostsRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$App_Types$PostsRoute,
				_evancz$url_parser$UrlParser$s('posts')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$App_Types$PostRoute,
					A2(
...
var _user$project$Util_Graphql$withVariable = F2(
	function ($var, query) {
		return _elm_lang$core$Native_Utils.update(
			query,
			{
...
var _user$project$Util_Graphql$createBody = function (query) {
...
var _user$project$Util_Graphql$send = F3(
		...
		return A2(
			...
			A2(
				...
				_elm_lang$http$Http$jsonBody(
					_user$project$Util_Graphql$createBody(query)))(
				_user$project$Util_Graphql$queryDecoder(decoder)));
	});
var _user$project$Util_Graphql$defaultQuery = {
	query: '',
	variables: {ctor: '[]'}
};
var _user$project$Util_Graphql$query = function (queryString) {
	return _elm_lang$core$Native_Utils.update(
		_user$project$Util_Graphql$defaultQuery,
		{query: queryString});
};
...
var _user$project$Article_Style$Post = {ctor: 'Post'};
var _user$project$Article_Style$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'bbsArticle', _p0));
}(
	{
		ctor: '::',
		_0: A2(
			...
			_user$project$Article_Style$Post,
			{
				ctor: '::',
...
var _user$project$Dashboard_Style$PostAbstract = {ctor: 'PostAbstract'};
var _user$project$Dashboard_Style$PostAbstractTitle = {ctor: 'PostAbstractTitle'};
var _user$project$Dashboard_Style$PostAbstractContainer = {ctor: 'PostAbstractContainer'};
var _user$project$Dashboard_Style$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'bbsDashboard', _p0));
}(
	{
		ctor: '::',
		_0: A2(
			...
			_user$project$Dashboard_Style$PostAbstractContainer,
			{
				ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A3(
										_rtfeldman$elm_css$Css$boxShadow3,
															...
															_0: _rtfeldman$elm_css$Css$children(
																{
																	...
																	_0: A2(
																		...
																		_user$project$Dashboard_Style$PostAbstractTitle,
																		{
																			ctor: '::',
																			_0: A3(
																	...
																	_1: {
																		...
																		_0: A2(
																			...
																			_user$project$Dashboard_Style$PostAbstract,
																			{
																				ctor: '::',
...
var _user$project$App_Style$PageHost = {ctor: 'PageHost'};
				...
				_1: {
					...
					_0: _rtfeldman$elm_css$Css_Elements$footer(
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: A2(_rtfeldman$elm_css$Css$property, 'box-shadow', 'inset 0px 10px 10px -10px #222'),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$width(
												_rtfeldman$elm_css$Css$pct(100)),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$height(
													_rtfeldman$elm_css$Css$px(_user$project$App_Style$footerSize)),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$boxSizing(_rtfeldman$elm_css$Css$borderBox),
													_1: {
															...
															_0: _rtfeldman$elm_css$Css$descendants(
																{
																	...
																	_0: A2(
																		...
																		_user$project$App_Style$SocialLinks,
																		{
																			ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							_user$project$App_Style$PageHost,
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$height(
									_rtfeldman$elm_css$Css$pct(100)),
						...
						_1: {
							...
							_0: A2(
								...
								_user$project$App_Style$Container,
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$relative),
									_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$paddingBottom(
																_rtfeldman$elm_css$Css$px(_user$project$App_Style$footerSize + 32)),
															_1: {
																ctor: '::',
																_0: _rtfeldman$elm_css$Css$backgroundColor(
																	A4(_rtfeldman$elm_css$Css$rgba, 220, 220, 220, 0.5)),
																_1: {
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Css$descendants(
																		{
							...
							_1: {
								...
								_0: A2(
									...
									_user$project$App_Style$ProfilePicture,
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$width(
										...
										_1: {
											...
											_1: {
												...
												_0: _rtfeldman$elm_css$Css$backgroundImage(
													_rtfeldman$elm_css$Css$url('img/profile.png')),
												_1: {
													ctor: '::',
...
var _user$project$App_Style$css = {
	...
	_1: {
		ctor: '::',
		_0: _user$project$Article_Style$css,
		_1: {
			ctor: '::',
...
var _user$project$Util_Markdown$basicOptions = {
	githubFlavored: _elm_lang$core$Maybe$Just(
...
var _user$project$Util_Markdown$toHtml = A2(
	_evancz$elm_markdown$Markdown$toHtmlWith,
	_user$project$Util_Markdown$basicOptions,
	{
		ctor: '::',
...
var _user$project$Dashboard_View$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('bbsDashboard');
var _user$project$Dashboard_View$id = _user$project$Dashboard_View$_p0.id;
var _user$project$Dashboard_View$class = _user$project$Dashboard_View$_p0.$class;
var _user$project$Dashboard_View$classList = _user$project$Dashboard_View$_p0.classList;
var _user$project$Dashboard_View$dashboardAbstract = function (post) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(
				A2(_elm_lang$core$Basics_ops['++'], '#/post/', post.id)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Dashboard_View$class(
						{
							ctor: '::',
							_0: _user$project$Dashboard_Style$PostAbstractContainer,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
					...
					_0: A2(
						_elm_lang$html$Html$header,
						{
							...
							_0: _user$project$Dashboard_View$class(
								{
									ctor: '::',
									_0: _user$project$Dashboard_Style$PostAbstractTitle,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						...
						_0: A2(
							_elm_lang$html$Html$article,
							{
								...
								_0: _user$project$Dashboard_View$class(
									{
										ctor: '::',
										_0: _user$project$Dashboard_Style$PostAbstract,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							{
								...
								_0: A2(
									...
									function (c) {
										return _user$project$Util_Markdown$toHtml(c);
									},
									post.summary),
								_1: {ctor: '[]'}
							}),
...
var _user$project$Dashboard_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Dashboard_View$dashboardAbstract, model.posts));
};

var _user$project$Article_View$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('bbsArticle');
var _user$project$Article_View$id = _user$project$Article_View$_p0.id;
var _user$project$Article_View$class = _user$project$Article_View$_p0.$class;
var _user$project$Article_View$classList = _user$project$Article_View$_p0.classList;
var _user$project$Article_View$view = function (model) {
	var _p1 = model.post;
	if (_p1.ctor === 'Just') {
		var _p2 = _p1._0;
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Article_View$class(
					{
						ctor: '::',
						_0: _user$project$Article_Style$Post,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
	...
	switch (_p0.ctor) {
		case 'PostsRoute':
			return A2(
				...
				_user$project$Dashboard_View$view(model.dashboardModel));
		case 'PostRoute':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$App_Types$ArticleMsg,
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Route not found.'),
					_1: {ctor: '[]'}
				});
	}
};
