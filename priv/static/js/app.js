...
var _user$project$Shared_Animation$delayMessage = F2(
	function (time, msg) {
		return A2(
			_elm_lang$core$Task$perform,
...
var _user$project$Shared_Animation$Animation = F2(
	function (a, b) {
		return {classes: a, config: b};
	});
var _user$project$Shared_Animation$AnimationConfig = F4(
	function (a, b, c, d) {
		return {baseClass: a, animationClass: b, endClass: c, delay: d};
	});
var _user$project$Shared_Animation$AnimationDelay = F2(
	function (a, b) {
		return {init: a, animation: b};
	});
var _user$project$Shared_Animation$End = {ctor: 'End'};
var _user$project$Shared_Animation$Animate = {ctor: 'Animate'};
var _user$project$Shared_Animation$update = F2(
	function (msg, animation) {
		var updateClass = function (classes) {
			return _elm_lang$core$Native_Utils.update(
				animation,
				{classes: classes});
		};
		...
		switch (_p0.ctor) {
			case 'Initialize':
				return {
					...
					_1: A2(_user$project$Shared_Animation$delayMessage, delay.init, _user$project$Shared_Animation$Animate)
				};
			case 'Animate':
				return {
					ctor: '_Tuple2',
					...
					_1: A2(_user$project$Shared_Animation$delayMessage, delay.animation, _user$project$Shared_Animation$End)
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$Shared_Animation$Initialize = {ctor: 'Initialize'};
var _user$project$Shared_Animation$Done = {ctor: 'Done'};
var _user$project$Shared_Animation$Animating = {ctor: 'Animating'};
var _user$project$Shared_Animation$Init = {ctor: 'Init'};

var _user$project$Shared_Style$FlashError = {ctor: 'FlashError'};
var _user$project$Shared_Style$FlashWarn = {ctor: 'FlashWarn'};
var _user$project$Shared_Style$FlashInfo = {ctor: 'FlashInfo'};
var _user$project$Shared_Style$FlashAnimationDone = {ctor: 'FlashAnimationDone'};
var _user$project$Shared_Style$FlashAnimationAnimating = {ctor: 'FlashAnimationAnimating'};
var _user$project$Shared_Style$FlashAnimationBase = {ctor: 'FlashAnimationBase'};
var _user$project$Shared_Style$FlashContainer = {ctor: 'FlashContainer'};
var _user$project$Shared_Style$Flash = {ctor: 'Flash'};
var _user$project$Shared_Style$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'bbs', _p0));
}(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$class,
			_user$project$Shared_Style$Flash,
			{
				ctor: '::',
				_0: A2(
				...
				_1: {
					...
					_1: {
						...
						_0: A4(
							...
							_rtfeldman$elm_css$Css_Colors$gray),
						_1: {
							ctor: '::',
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Css$class,
				_user$project$Shared_Style$FlashContainer,
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_user$project$Shared_Style$FlashAnimationBase,
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$class,
						_user$project$Shared_Style$FlashAnimationAnimating,
						{
							ctor: '::',
							_0: A2(_rtfeldman$elm_css$Css$property, 'transition', 'opacity 1s linear'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_rtfeldman$elm_css$Css$class,
							_user$project$Shared_Style$FlashAnimationDone,
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$opacity(
						...
						_1: {
							...
							_0: A2(
								_rtfeldman$elm_css$Css$class,
								_user$project$Shared_Style$FlashInfo,
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$backgroundColor(
										_rtfeldman$elm_css$Css$hex('81C784')),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									_rtfeldman$elm_css$Css$class,
									_user$project$Shared_Style$FlashWarn,
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$backgroundColor(
											_rtfeldman$elm_css$Css$hex('ffB74D')),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_rtfeldman$elm_css$Css$class,
										_user$project$Shared_Style$FlashError,
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$backgroundColor(
												_rtfeldman$elm_css$Css$hex('E57373')),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Shared_Types$initialArticle = {
	id: 'new',
	title: 'Title',
	content: 'Content',
	summary: 'Summary',
	insertedAt: _elm_lang$core$Date$fromTime(0),
	saved: false
};
var _user$project$Shared_Types$initialContext = {
	articles: {ctor: '[]'},
	jwt: _elm_lang$core$Maybe$Nothing,
	isLoggedIn: false
};
var _user$project$Shared_Types$JWT = F2(
	function (a, b) {
		return {token: a, exp: b};
	});
var _user$project$Shared_Types$jwtDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Shared_Types$JWT,
...
var _user$project$Shared_Types$Context = F3(
	function (a, b, c) {
		return {articles: a, jwt: b, isLoggedIn: c};
	});
var _user$project$Shared_Types$Flash = F3(
	function (a, b, c) {
		return {id: a, message: b, animation: c};
	});
var _user$project$Shared_Types$Article = F6(
	function (a, b, c, d, e, f) {
		return {id: a, title: b, content: c, summary: d, insertedAt: e, saved: f};
	});
...
var _user$project$Edit_Types$initialModel = {article: _user$project$Shared_Types$initialArticle, deleteAttempt: false};
var _user$project$Edit_Types$Model = F2(
	function (a, b) {
		return {article: a, deleteAttempt: b};
	});
var _user$project$Edit_Types$StopRemoveAttempt = {ctor: 'StopRemoveAttempt'};
var _user$project$Edit_Types$AttemptRemoveArticle = {ctor: 'AttemptRemoveArticle'};
var _user$project$Edit_Types$RemoveArticle = {ctor: 'RemoveArticle'};
var _user$project$Edit_Types$NewArticle = {ctor: 'NewArticle'};
var _user$project$Edit_Types$ArticleDeleteResponse = function (a) {
	return {ctor: 'ArticleDeleteResponse', _0: a};
};
var _user$project$Edit_Types$ArticleUpdateResponse = function (a) {
	return {ctor: 'ArticleUpdateResponse', _0: a};
};
var _user$project$Edit_Types$SaveArticle = {ctor: 'SaveArticle'};
var _user$project$Edit_Types$ContentChange = function (a) {
	return {ctor: 'ContentChange', _0: a};
};
var _user$project$Edit_Types$SummaryChange = function (a) {
	return {ctor: 'SummaryChange', _0: a};
};
var _user$project$Edit_Types$TitleChange = function (a) {
	return {ctor: 'TitleChange', _0: a};
};
var _user$project$Edit_Types$SetArticle = function (a) {
	return {ctor: 'SetArticle', _0: a};
};
var _user$project$Edit_Types$SetUrl = function (a) {
...
var _user$project$App_Types$initialModel = function (route) {
	return {
		...
		username: '',
		password: '',
		currentTime: _elm_lang$core$Time$second
	};
};
var _user$project$App_Types$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {route: a, flashes: b, editModel: c, context: d, showLoginModal: e, username: f, password: g, currentTime: h};
	});
...
var _user$project$App_Types$ArticleRoute = function (a) {
	return {ctor: 'ArticleRoute', _0: a};
};
var _user$project$App_Types$DashboardRoute = {ctor: 'DashboardRoute'};
var _user$project$App_Types$NoOp = {ctor: 'NoOp'};
var _user$project$App_Types$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$App_Types$LoginResponse = function (a) {
	return {ctor: 'LoginResponse', _0: a};
};
var _user$project$App_Types$Logout = {ctor: 'Logout'};
var _user$project$App_Types$Login = {ctor: 'Login'};
var _user$project$App_Types$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _user$project$App_Types$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _user$project$App_Types$EditMsg = function (a) {
	return {ctor: 'EditMsg', _0: a};
};
var _user$project$App_Types$AnimationMsg = F2(
	function (a, b) {
		return {ctor: 'AnimationMsg', _0: a, _1: b};
	});
var _user$project$App_Types$IncomingArticles = function (a) {
	return {ctor: 'IncomingArticles', _0: a};
};
var _user$project$App_Types$IncomingArticle = function (a) {
	return {ctor: 'IncomingArticle', _0: a};
};
var _user$project$App_Types$NewContext = function (a) {
	return {ctor: 'NewContext', _0: a};
};
...
var _user$project$App_Types$CloseLoginModal = {ctor: 'CloseLoginModal'};
var _user$project$App_Types$ShowLoginModal = {ctor: 'ShowLoginModal'};
var _user$project$App_Types$ShowFlash = function (a) {
	return {ctor: 'ShowFlash', _0: a};
};
var _user$project$App_Types$SetUrl = function (a) {
	return {ctor: 'SetUrl', _0: a};
};
...
var _user$project$App_Routes$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$App_Types$DashboardRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$App_Types$ArticleRoute,
				A2(
...
var _user$project$App_Routes$parseLocation = function (location) {
	var _p0 = A2(_evancz$url_parser$UrlParser$parseHash, _user$project$App_Routes$matchers, location);
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
var _user$project$Shared_List$updateOrAdd = F2(
	function (item, list) {
		var _p0 = list;
		if (_p0.ctor === '::') {
			var _p2 = _p0._1;
			var _p1 = _p0._0;
			return _elm_lang$core$Native_Utils.eq(_p1.id, item.id) ? {ctor: '::', _0: item, _1: _p2} : {
				ctor: '::',
				_0: _p1,
				_1: A2(_user$project$Shared_List$updateOrAdd, item, _p2)
			};
		} else {
			return {
				ctor: '::',
...
var _user$project$Shared_List$generateId = function (list) {
	var firstGap = F2(
		function (last, ids) {
			firstGap:
			while (true) {
				...
				if (_p3.ctor === '::') {
					var _p4 = _p3._0;
					if (_elm_lang$core$Native_Utils.cmp(last, _p4 - 1) < 0) {
						return last + 1;
					} else {
						var _v2 = _p4,
							_v3 = _p3._1;
...
var _user$project$Shared_List$find = F2(
...
var _user$project$Shared_List$findById = F2(
	function (id, list) {
		return A2(
			_user$project$Shared_List$find,
			function (_p7) {
				return A2(
					F2(
						function (x, y) {
...
var _user$project$Shared_List$updateIf = F3(
	function (predicate, updateFn, list) {
		var _p8 = list;
		if (_p8.ctor === '[]') {
			return list;
		} else {
			...
			return {
				ctor: '::',
				_0: predicate(_p9) ? updateFn(_p9) : _p9,
				_1: A3(_user$project$Shared_List$updateIf, predicate, updateFn, _p8._1)
			};
		}
	});

var _user$project$Graphql$queryDecoder = function (decoder) {
	return A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
...
var _user$project$Graphql$postRequest = F3(
...
var _user$project$Graphql$withHeader = F3(
...
var _user$project$Graphql$withToken = F2(
	function (token, query) {
		return A3(
			_user$project$Graphql$withHeader,
			'Authorization',
			A2(_elm_lang$core$Basics_ops['++'], 'Bearer ', token),
			query);
	});
var _user$project$Graphql$withVariable = F2(
	function ($var, query) {
		return _elm_lang$core$Native_Utils.update(
			query,
			{
				variables: {ctor: '::', _0: $var, _1: query.variables}
			});
	});
var _user$project$Graphql$createBody = function (query) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'query',
				_1: _elm_lang$core$Json_Encode$string(query.query)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'variables',
					_1: _elm_lang$core$Json_Encode$object(query.variables)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Graphql$send = F3(
	function (response, decoder, query) {
		return A2(
			_elm_lang$http$Http$send,
			response,
			A2(
				_user$project$Graphql$postRequest,
				query.headers,
				_elm_lang$http$Http$jsonBody(
					_user$project$Graphql$createBody(query)))(
				_user$project$Graphql$queryDecoder(decoder)));
	});
var _user$project$Graphql$toTask = F2(
...
var _user$project$Graphql$defaultQuery = {
	query: '',
	variables: {ctor: '[]'},
	headers: {ctor: '[]'}
};
var _user$project$Graphql$query = function (queryString) {
	return _elm_lang$core$Native_Utils.update(
		_user$project$Graphql$defaultQuery,
		{query: queryString});
};
var _user$project$Graphql$Query = F3(
	function (a, b, c) {
		return {query: a, variables: b, headers: c};
	});

var _user$project$Shared_Service$deleteArticle = F3(
	function (article, context, resultMsg) {
		var _p0 = context.jwt;
		if (_p0.ctor === 'Just') {
			return A2(
				_user$project$Graphql$send,
				resultMsg,
				A2(
					_elm_lang$core$Json_Decode$at,
					{
				...
				A2(
					_user$project$Graphql$withToken,
					_p0._0.token,
					A2(
						_user$project$Graphql$withVariable,
						{
							ctor: '_Tuple2',
							_0: 'id',
							_1: _elm_lang$core$Json_Encode$string(article.id)
						},
						_user$project$Graphql$query('\n                mutation ($id: String!) {\n                    post: deletePost(id: $id) {\n                        id\n                    }\n                }\n            '))));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _user$project$Shared_Service$articleEncoder = function (article) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$string(article.title)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'content',
					_1: _elm_lang$core$Json_Encode$string(article.content)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'summary',
						_1: _elm_lang$core$Json_Encode$string(article.summary)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$Shared_Service$dateDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (val) {
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Shared_Service$articleDecoder = A4(
	...
	A3(
		...
		'insertedAt',
		_user$project$Shared_Service$dateDecoder,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'summary',
			_elm_lang$core$Json_Decode$string,
			A3(
				...
				A3(
					...
					A3(
						...
						'id',
						_elm_lang$core$Json_Decode$string,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Shared_Types$Article)))))));
var _user$project$Shared_Service$updateOrInsertArticle = F3(
	function (article, context, resultMsg) {
		var _p2 = _elm_lang$core$Native_Utils.eq(article.id, 'new') ? {
			ctor: '_Tuple2',
		...
		var queryString = _p2._0;
		var idVariable = _p2._1;
		var variables = A2(
			_elm_lang$core$Basics_ops['++'],
			idVariable,
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'post',
					_1: _user$project$Shared_Service$articleEncoder(article)
				},
				_1: {ctor: '[]'}
			});
		var _p3 = context.jwt;
		if (_p3.ctor === 'Just') {
			return A2(
				...
				A2(
					...
					_user$project$Shared_Service$articleDecoder))(
				A2(
					_user$project$Graphql$withToken,
					_p3._0.token,
					A3(
						_elm_lang$core$Basics$flip,
						_elm_lang$core$List$foldl(_user$project$Graphql$withVariable),
						variables,
						_user$project$Graphql$query(queryString))));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _user$project$Shared_Service$fetchArticle = F2(
...
var _user$project$Shared_Service$fetchArticleIfNecessary = F3(
	function (id, context, messageType) {
		var _p4 = A2(_user$project$Shared_List$findById, id, context.articles);
		if (_p4.ctor === 'Just') {
			return _elm_lang$core$Platform_Cmd$none;
		} else {
			return A2(_user$project$Shared_Service$fetchArticle, id, messageType);
		}
	});
var _user$project$Shared_Service$fetchArticles = function (messageType) {
	return A2(
		_user$project$Graphql$send,
		messageType,
		A2(
			...
			_elm_lang$core$Json_Decode$list(_user$project$Shared_Service$articleDecoder)))(
		_user$project$Graphql$query('\n    {\n        posts {\n            id\n            title\n            content\n            summary\n            insertedAt\n        }\n    }\n    '));
};
var _user$project$Shared_Service$jwtDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Shared_Types$JWT,
	A2(_elm_lang$core$Json_Decode$field, 'token', _elm_lang$core$Json_Decode$string),
	A2(
		...
		A2(
			...
			_elm_lang$core$Json_Decode$string)));
var _user$project$Shared_Service$login = F3(
	function (username, password, messageType) {
		return A2(
			_user$project$Graphql$send,
			messageType,
			A2(
				...
				_user$project$Shared_Service$jwtDecoder))(
			A2(
				_user$project$Graphql$withVariable,
				{
					ctor: '_Tuple2',
...
var _user$project$Shared_Misc$isLoggedIn = F2(
	function (context, time) {
		var _p0 = context.jwt;
		if (_p0.ctor === 'Nothing') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.cmp(_p0._0.exp, time / 1000) > 0;
		}
	});
var _user$project$Shared_Misc$getToken = function (context) {
	var _p1 = context.jwt;
	if (_p1.ctor === 'Just') {
		return _elm_lang$core$Maybe$Just(_p1._0.token);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Shared_Misc$stringifyError = function (error) {
	var _p2 = error;
	switch (_p2.ctor) {
		case 'BadUrl':
			return A2(
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'Response body: ',
									A2(_elm_lang$core$Debug$log, 'Response body', _p3.body)))))));
		case 'BadPayload':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_elm_lang$core$Debug$log, 'Parse error', _p2._0),
					A2(
						_elm_lang$core$Basics_ops['++'],
						'\n\nResponse body: ',
						A2(_elm_lang$core$Debug$log, 'Response body', _p2._1.body))));
		default:
			return 'Cannot connect to the sever.';
	}
};

var _user$project$Shared_Update$sendSingleMessage = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$always(msg),
		_elm_lang$core$Task$succeed(
...
var _user$project$Shared_Update$sendMessage = F2(
	function (msg, input) {
		return A2(
			_elm_lang$core$Task$perform,
			msg,
			_elm_lang$core$Task$succeed(input));
	});
var _user$project$Shared_Update$evaluateMaybe = F3(
	function (interpretOutMsg, defaultCmd, _p0) {
		var _p1 = _p0;
		var _p4 = _p1._0;
		var _p2 = function () {
			var _p3 = _p1._2;
			if (_p3.ctor === 'Just') {
				return A2(interpretOutMsg, _p3._0, _p4);
			} else {
				return {ctor: '_Tuple2', _0: _p4, _1: defaultCmd};
			}
		}();
		var newModel = _p2._0;
		var newCmd = _p2._1;
...
var _user$project$Shared_Update$mapMainCmd = function (_p5) {
	var _p6 = _p5;
	return {
		ctor: '_Tuple2',
		_0: _p6._0,
...
var _user$project$Shared_Update$mapCmd = F2(
	function (mapType, _p7) {
		var _p8 = _p7;
		return {
			ctor: '_Tuple3',
			_0: _p8._0,
			_1: A2(_elm_lang$core$Platform_Cmd$map, mapType, _p8._1),
			_2: _p8._2
		};
	});
var _user$project$Shared_Update$applyUpdates = function (_p9) {
	var _p10 = _p9;
	return {ctor: '_Tuple3', _0: _p10._1, _1: _p10._2, _2: _p10._3};
};
var _user$project$Shared_Update$mapUpdate = F2(
	function (updateFn, _p11) {
		var _p12 = _p11;
		var _p13 = _p12._0;
		return {
			ctor: '_Tuple4',
			_0: _p13,
			_1: A2(updateFn, _p13, _p12._1),
			_2: _p12._2,
			_3: _p12._3
		};
	});
var _user$project$Shared_Update$withModel = F2(
	function (model, _p14) {
		var _p15 = _p14;
		return {ctor: '_Tuple4', _0: _p15._0, _1: model, _2: _p15._1, _3: _p15._2};
	});
var _user$project$Shared_Update$collect = function (_p16) {
	var _p17 = _p16;
	return {ctor: '_Tuple2', _0: _p17._1, _1: _p17._2};
};
var _user$project$Shared_Update$dispatch = F2(
	function (updateFn, _p18) {
		var _p19 = _p18;
		var _p21 = _p19._0;
		var _p20 = A2(updateFn, _p21, _p19._1);
...
var _user$project$Shared_Update$initDispatch = F2(
	function (msg, model) {
		return {ctor: '_Tuple3', _0: msg, _1: model, _2: _elm_lang$core$Platform_Cmd$none};
	});

var _user$project$Helper$createFlash = function (msg) {
	return {
		id: 0,
		message: msg,
		animation: {
			classes: {
				ctor: '::',
				_0: _user$project$Shared_Style$FlashAnimationBase,
				_1: {ctor: '[]'}
			},
			config: {
				baseClass: _user$project$Shared_Style$FlashAnimationBase,
				animationClass: _user$project$Shared_Style$FlashAnimationAnimating,
				endClass: _user$project$Shared_Style$FlashAnimationDone,
				delay: {init: 0, animation: 1000}
			}
		}
	};
};
var _user$project$Helper$showFlashCommand = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
		_user$project$App_Types$ShowFlash,
		_elm_lang$core$Task$succeed(
			_user$project$Helper$createFlash(msg)));
};
var _user$project$Helper$showInfo = function (_p0) {
	return _user$project$Helper$showFlashCommand(
		_user$project$Shared_Types$Info(_p0));
};
var _user$project$Helper$showWarn = function (_p1) {
	return _user$project$Helper$showFlashCommand(
		_user$project$Shared_Types$Warn(_p1));
};
var _user$project$Helper$showError = function (_p2) {
	return _user$project$Helper$showFlashCommand(
		_user$project$Shared_Types$Error(_p2));
};

var _user$project$Edit_State$updateContext = function (context) {
	return A2(
		_elm_lang$core$Task$perform,
		_user$project$App_Types$NewContext,
		_elm_lang$core$Task$succeed(context));
};
var _user$project$Edit_State$updateContextWithArticle = F2(
	function (article, context) {
		var articles = A2(_user$project$Shared_List$updateOrAdd, article, context.articles);
		return _user$project$Edit_State$updateContext(
			_elm_lang$core$Native_Utils.update(
				context,
				{articles: articles}));
	});
var _user$project$Edit_State$deleteArticle = F2(
	function (model, context) {
		return _elm_lang$core$Native_Utils.eq(model.article.id, 'new') ? _elm_lang$core$Platform_Cmd$none : A3(_user$project$Shared_Service$deleteArticle, model.article, context, _user$project$Edit_Types$ArticleDeleteResponse);
	});
var _user$project$Edit_State$showIfNotLoggedIn = function (context) {
	return context.isLoggedIn ? _elm_lang$core$Platform_Cmd$none : _user$project$Helper$showError('You are not logged in!');
};
var _user$project$Edit_State$update = F3(
		...
		switch (_p0.ctor) {
			case 'SetUrl':
				return {
					...
					_2: A2(
						_elm_lang$core$Task$perform,
						_user$project$App_Types$SetUrl,
			...
			case 'SetArticle':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{article: _p1}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: A2(_user$project$Edit_State$updateContextWithArticle, _p1, context)
				};
			case 'TitleChange':
				var article = model.article;
				var newArticle = _elm_lang$core$Native_Utils.update(
					article,
					{title: _p0._0, saved: false});
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{article: newArticle}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: A2(_user$project$Edit_State$updateContextWithArticle, newArticle, context)
				};
			case 'SummaryChange':
				var article = model.article;
				var newArticle = _elm_lang$core$Native_Utils.update(
					article,
					{summary: _p0._0, saved: false});
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'SaveArticle':
				var cmd = A3(_user$project$Shared_Service$updateOrInsertArticle, model.article, context, _user$project$Edit_Types$ArticleUpdateResponse);
				return {
					ctor: '_Tuple3',
					_0: model,
					_1: cmd,
					_2: _user$project$Edit_State$showIfNotLoggedIn(context)
				};
			case 'ArticleUpdateResponse':
				if (_p0._0.ctor === 'Ok') {
					var _p3 = _p0._0._0;
					var newContext = _elm_lang$core$Native_Utils.update(
						...
						{
							articles: A2(
								_user$project$Shared_List$updateOrAdd,
								_p3,
								A2(
									_elm_lang$core$List$filter,
									function (_p2) {
					...
					return {
						...
						_2: _elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: _user$project$Helper$showInfo('Successfully saved article.'),
								_1: {
									ctor: '::',
									_0: _user$project$Edit_State$updateContext(newContext),
									_1: {
										ctor: '::',
										_0: _elm_lang$navigation$Navigation$modifyUrl(
											A2(_elm_lang$core$Basics_ops['++'], '/#/edit/', _p3.id)),
										_1: {ctor: '[]'}
									}
								}
							})
					...
					return {
						...
						_0: model,
						_1: _elm_lang$core$Platform_Cmd$none,
						_2: _user$project$Helper$showError(
							_user$project$Shared_Misc$stringifyError(_p0._0._0))
					};
				}
			case 'ArticleDeleteResponse':
				if (_p0._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple3',
						_0: model,
						_1: _elm_lang$core$Platform_Cmd$none,
						_2: _user$project$Helper$showInfo('Article successfully deleted.')
					};
				} else {
					return {
						ctor: '_Tuple3',
			...
			case 'NewArticle':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{article: _user$project$Shared_Types$initialArticle}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: A2(_user$project$Edit_State$updateContextWithArticle, _user$project$Shared_Types$initialArticle, context),
							_1: {
								ctor: '::',
								_0: _elm_lang$navigation$Navigation$modifyUrl('/#/edit/new'),
								_1: {ctor: '[]'}
							}
						})
				};
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							article: A2(
								_elm_lang$core$Maybe$withDefault,
								_user$project$Shared_Types$initialArticle,
								_elm_lang$core$List$head(newContext.articles)),
							deleteAttempt: false
						}),
					_1: A2(_user$project$Edit_State$deleteArticle, model, context),
					_2: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _user$project$Edit_State$updateContext(newContext),
							_1: {
								ctor: '::',
								_0: _user$project$Edit_State$showIfNotLoggedIn(context),
								_1: {ctor: '[]'}
							}
						})
				};
			case 'AttemptRemoveArticle':
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$App_State$updateWithId = F2(
	function (item, list) {
		return A3(
			_user$project$Shared_List$updateIf,
			function (_p0) {
				return A2(
					F2(
						function (x, y) {
			...
			_elm_lang$core$Basics$always(item),
			list);
	});
var _user$project$App_State$publishArticle = F2(
	function (article, model) {
		var editModel = model.editModel;
		var context = model.context;
		var articles = A2(_user$project$Shared_List$updateOrAdd, article, model.context.articles);
		var newContext = _elm_lang$core$Native_Utils.update(
			context,
			{articles: articles});
		return A2(
...
var _user$project$App_State$foldUpdate = F3(
	function (updateFn, list, model) {
		var foldMethod = F2(
			function (item, _p1) {
				var _p2 = _p1;
				var _p3 = A2(updateFn, item, _p2._0);
				var newModel = _p3._0;
				var newCmd = _p3._1;
				return A2(
					_NoRedInk$rocket_update$Rocket_ops['=>'],
...
var _user$project$App_State$getEditRouteId = function (model) {
	var _p4 = model.route;
	if (_p4.ctor === 'EditRoute') {
		return _elm_lang$core$Maybe$Just(_p4._0);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$App_State$updateEdit = F2(
	function (msg, model) {
		return _user$project$Shared_Update$mapMainCmd(
			A2(
				_user$project$Shared_Update$mapCmd,
				_user$project$App_Types$EditMsg,
				_user$project$Shared_Update$applyUpdates(
					A2(
						_user$project$Shared_Update$mapUpdate,
						F2(
							function (childM, mainM) {
								return _elm_lang$core$Native_Utils.update(
									mainM,
									{editModel: childM});
							}),
						A2(
							_user$project$Shared_Update$withModel,
							model,
							A3(_user$project$Edit_State$update, msg, model.editModel, model.context))))));
	});
var _user$project$App_State$decodeContext = _elm_lang$core$Json_Decode$decodeValue(
	A4(
		...
		A2(
			_elm_lang$core$Json_Decode$field,
			'jwt',
			_elm_lang$core$Json_Decode$nullable(_user$project$Shared_Types$jwtDecoder)),
		A2(_elm_lang$core$Json_Decode$field, 'isLoggedIn', _elm_lang$core$Json_Decode$bool)));
var _user$project$App_State$mapStorageInput = function (input) {
	var _p5 = _user$project$App_State$decodeContext(input);
	if (_p5.ctor === 'Ok') {
		return _user$project$App_Types$SetContext(_p5._0);
	} else {
		var _p6 = A2(_elm_lang$core$Debug$log, 'Error in mapStorageInput:', _p5._0);
...
var _user$project$App_State$encodeContext = function (context) {
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'token',
						_1: _elm_lang$core$Json_Encode$string(_p8.token)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'exp',
							_1: _elm_lang$core$Json_Encode$float(_p8.exp)
						},
						_1: {ctor: '[]'}
					}
				});
	...
	var articleEncoder = function (article) {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
							...
							_1: {
								...
								_0: {
									...
									_1: _elm_lang$core$Json_Encode$string(
										_elm_lang$core$Basics$toString(article.insertedAt))
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'saved',
										_1: _elm_lang$core$Json_Encode$bool(article.saved)
									},
									_1: {ctor: '[]'}
								}
							}
	...
	var encodedArticles = _elm_lang$core$Json_Encode$list(
		A2(_elm_lang$core$List$map, articleEncoder, context.articles));
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'articles', _1: encodedArticles},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'jwt', _1: encodedToken},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'isLoggedIn',
						_1: _elm_lang$core$Json_Encode$bool(context.isLoggedIn)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$App_State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$App_State$storageInput(_user$project$App_State$mapStorageInput),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$App_Types$Tick),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$App_State$sendToStorage = function (context) {
	return _user$project$App_State$storage(
		_user$project$App_State$encodeContext(context));
};
var _user$project$App_State$update = F2(
	function (msg, model) {
		...
		switch (_p9.ctor) {
			case 'UrlChange':
				var newRoute = _user$project$App_Routes$parseLocation(_p9._0);
				...
				switch (_p10.ctor) {
					case 'DashboardRoute':
						return A2(
							_NoRedInk$rocket_update$Rocket_ops['=>'],
							newModel,
							_user$project$Shared_Service$fetchArticles(_user$project$App_Types$IncomingArticles));
					case 'ArticleRoute':
						return A2(
							_NoRedInk$rocket_update$Rocket_ops['=>'],
							newModel,
							A3(_user$project$Shared_Service$fetchArticleIfNecessary, _p10._0, model.context, _user$project$App_Types$IncomingArticle));
					case 'EditRoute':
						return model.context.isLoggedIn ? A2(
							_NoRedInk$rocket_update$Rocket_ops['=>'],
							newModel,
							_user$project$Shared_Service$fetchArticles(_user$project$App_Types$IncomingArticles)) : A2(
							_NoRedInk$rocket_update$Rocket_ops['=>'],
							_elm_lang$core$Native_Utils.update(
								model,
								{route: _user$project$App_Types$DashboardRoute}),
							_elm_lang$navigation$Navigation$modifyUrl('/'));
					default:
						return A2(_NoRedInk$rocket_update$Rocket_ops['=>'], newModel, _elm_lang$core$Platform_Cmd$none);
				}
			case 'SetUrl':
				return A2(
					_NoRedInk$rocket_update$Rocket_ops['=>'],
			...
			case 'NewContext':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{context: _p11}),
					_user$project$App_State$sendToStorage(_p11));
			case 'ShowFlash':
				var flashWithId = _elm_lang$core$Native_Utils.update(
					_p9._0,
					{
						id: _user$project$Shared_List$generateId(model.flashes)
					});
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						flashes: {ctor: '::', _0: flashWithId, _1: model.flashes}
					});
				return A2(
					_NoRedInk$rocket_update$Rocket_ops['=>'],
					newModel,
					A2(
						_user$project$Shared_Animation$delayMessage,
						3000,
						A2(_user$project$App_Types$AnimationMsg, flashWithId, _user$project$Shared_Animation$Initialize)));
			case 'RemoveFlash':
				return A2(
					_NoRedInk$rocket_update$Rocket_ops['=>'],
					_elm_lang$core$Native_Utils.update(
			...
			case 'AnimationMsg':
				...
				var _p14 = A2(_user$project$Shared_Animation$update, _p15, _p16.animation);
				var animation = _p14._0;
				var animationCmd = _p14._1;
				var newFlash = _elm_lang$core$Native_Utils.update(
					_p16,
					{animation: animation});
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						flashes: A2(_user$project$App_State$updateWithId, newFlash, model.flashes)
					});
				return A2(
					_NoRedInk$rocket_update$Rocket_ops['=>'],
					newModel,
					_elm_lang$core$Platform_Cmd$batch(
						{
							...
							_0: A2(
								...
								_user$project$App_Types$AnimationMsg(_p16),
								animationCmd),
							_1: {
								ctor: '::',
								_0: nextCmd,
			...
			case 'EditMsg':
				return A2(_user$project$App_State$updateEdit, _p9._0, model);
			case 'IncomingArticle':
				if (_p9._0.ctor === 'Ok') {
					return A2(_user$project$App_State$publishArticle, _p9._0._0, model);
				} else {
					return A2(
						_NoRedInk$rocket_update$Rocket_ops['=>'],
						model,
						_user$project$Helper$showError(
							_user$project$Shared_Misc$stringifyError(_p9._0._0)));
				}
			case 'IncomingArticles':
				if (_p9._0.ctor === 'Ok') {
					var _p17 = A3(_user$project$App_State$foldUpdate, _user$project$App_State$publishArticle, _p9._0._0, model);
					var newModel = _p17._0;
					var newCmd = _p17._1;
					var editId = A2(
						_elm_lang$core$Maybe$withDefault,
						'',
						_user$project$App_State$getEditRouteId(newModel));
					var articleInContext = A2(_user$project$Shared_List$findById, editId, newModel.context.articles);
					var firstArticle = A2(
						_elm_lang$core$Maybe$withDefault,
						_user$project$Shared_Types$initialArticle,
						_elm_lang$core$List$head(newModel.context.articles));
					var currentArticle = A2(_elm_lang$core$Maybe$withDefault, firstArticle, articleInContext);
					var _p18 = A2(
						_user$project$App_State$updateEdit,
						_user$project$Edit_Types$SetArticle(currentArticle),
						newModel);
					var newModelFromEdit = _p18._0;
					var newCmdFromEdit = _p18._1;
					return A2(
						_NoRedInk$rocket_update$Rocket_ops['=>'],
						newModelFromEdit,
						_elm_lang$core$Platform_Cmd$batch(
			...
			case 'Login':
				return A2(
					_NoRedInk$rocket_update$Rocket_ops['=>'],
					model,
					A3(_user$project$Shared_Service$login, model.username, model.password, _user$project$App_Types$LoginResponse));
			case 'Logout':
				var context = model.context;
				var newContext = _elm_lang$core$Native_Utils.update(
					context,
					{jwt: _elm_lang$core$Maybe$Nothing, isLoggedIn: false});
				return A2(
					_NoRedInk$rocket_update$Rocket_ops['=>'],
					model,
					A2(_user$project$Shared_Update$sendMessage, _user$project$App_Types$NewContext, newContext));
			case 'LoginResponse':
				if (_p9._0.ctor === 'Ok') {
					var context = model.context;
					var newContext = _elm_lang$core$Native_Utils.update(
						context,
						{
							jwt: _elm_lang$core$Maybe$Just(_p9._0._0),
							isLoggedIn: true
						});
					return A2(
						_NoRedInk$rocket_update$Rocket_ops['=>'],
						...
						_elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: _user$project$Helper$showInfo('Successfully logged in.'),
								_1: {
									ctor: '::',
									_0: _user$project$Shared_Update$sendSingleMessage(_user$project$App_Types$CloseLoginModal),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Shared_Update$sendMessage, _user$project$App_Types$NewContext, newContext),
										_1: {ctor: '[]'}
									}
								}
							}));
					...
					return A2(
						...
						_elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: _user$project$Helper$showError('Wrong login credentials!'),
								_1: {ctor: '[]'}
							}));
				}
			case 'Tick':
				...
				var newContext = _elm_lang$core$Native_Utils.update(
					context,
					{
						isLoggedIn: A2(_user$project$Shared_Misc$isLoggedIn, context, _p19)
					});
				var storeCmd = (!_elm_lang$core$Native_Utils.eq(context.isLoggedIn, newContext.isLoggedIn)) ? A2(_user$project$Shared_Update$sendMessage, _user$project$App_Types$NewContext, newContext) : _elm_lang$core$Platform_Cmd$none;
				return A2(
					_NoRedInk$rocket_update$Rocket_ops['=>'],
					_elm_lang$core$Native_Utils.update(
						model,
					...
					storeCmd);
			default:
				return A2(_NoRedInk$rocket_update$Rocket_ops['=>'], model, _elm_lang$core$Platform_Cmd$none);
		}
	});
var _user$project$App_State$init = function (location) {
	var currentRoute = _user$project$App_Routes$parseLocation(location);
	return A2(
		_user$project$App_State$update,
		_user$project$App_Types$UrlChange(location),
		_user$project$App_Types$initialModel(currentRoute));
};

var _user$project$Edit_Style$NotSaved = {ctor: 'NotSaved'};
var _user$project$Edit_Style$Right = {ctor: 'Right'};
var _user$project$Edit_Style$DeleteModal = {ctor: 'DeleteModal'};
var _user$project$Edit_Style$Hidden = {ctor: 'Hidden'};
var _user$project$Edit_Style$Active = {ctor: 'Active'};
var _user$project$Edit_Style$ModifyButtons = {ctor: 'ModifyButtons'};
var _user$project$Edit_Style$ButtonList = {ctor: 'ButtonList'};
var _user$project$Edit_Style$Separator = {ctor: 'Separator'};
var _user$project$Edit_Style$ArticlePreview = {ctor: 'ArticlePreview'};
var _user$project$Edit_Style$ArticleContentEdit = {ctor: 'ArticleContentEdit'};
var _user$project$Edit_Style$ArticleSummaryEdit = {ctor: 'ArticleSummaryEdit'};
var _user$project$Edit_Style$ArticleTitleEdit = {ctor: 'ArticleTitleEdit'};
var _user$project$Edit_Style$ArticleEdit = {ctor: 'ArticleEdit'};
var _user$project$Edit_Style$SideBar = {ctor: 'SideBar'};
var _user$project$Edit_Style$ButtonRed = {ctor: 'ButtonRed'};
var _user$project$Edit_Style$ButtonGreen = {ctor: 'ButtonGreen'};
var _user$project$Edit_Style$EditContainer = {ctor: 'EditContainer'};
var _user$project$Edit_Style$EditButtons = {ctor: 'EditButtons'};
var _user$project$Edit_Style$EditNav = {ctor: 'EditNav'};
var _user$project$Edit_Style$Edit = {ctor: 'Edit'};
var _user$project$Edit_Style$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'bbsEdit', _p0));
}(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$class,
			_user$project$Edit_Style$Edit,
			{
				ctor: '::',
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Css$class,
				_user$project$Edit_Style$EditNav,
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$displayFlex,
					_1: {
								...
								_1: {
									...
									_1: {
										...
										_0: A3(
											...
											_rtfeldman$elm_css$Css$hex('01579b')),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$zIndex(
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_user$project$Edit_Style$EditButtons,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$children(
							{
								...
								_1: {
									...
									_0: A2(
										_rtfeldman$elm_css$Css$class,
										_user$project$Edit_Style$ButtonGreen,
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$backgroundColor(
												A4(_rtfeldman$elm_css$Css$rgba, 76, 175, 80, 0.5)),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$hover(
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$backgroundColor(
															A3(_rtfeldman$elm_css$Css$rgb, 76, 175, 80)),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
									...
									_1: {
										...
										_0: A2(
											_rtfeldman$elm_css$Css$class,
											_user$project$Edit_Style$ButtonRed,
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$backgroundColor(
													A4(_rtfeldman$elm_css$Css$rgba, 239, 83, 80, 0.5)),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$hover(
														{
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$backgroundColor(
																A3(_rtfeldman$elm_css$Css$rgb, 239, 83, 80)),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$class,
						_user$project$Edit_Style$ModifyButtons,
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$displayFlex,
							_1: {
					...
					_1: {
						...
						_0: A2(
							_rtfeldman$elm_css$Css$class,
							_user$project$Edit_Style$EditContainer,
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$displayFlex,
								_1: {
						...
						_1: {
							...
							_0: A2(
								_rtfeldman$elm_css$Css$class,
								_user$project$Edit_Style$SideBar,
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$displayFlex,
									_1: {
							...
							_1: {
								...
								_0: A2(
									_rtfeldman$elm_css$Css$class,
									_user$project$Edit_Style$ArticleEdit,
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$displayFlex,
										_1: {
								...
								_1: {
									...
									_0: A2(
										_rtfeldman$elm_css$Css$class,
										_user$project$Edit_Style$ArticleTitleEdit,
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$height(
												_rtfeldman$elm_css$Css$px(50)),
									...
									_1: {
										...
										_0: A2(
											_rtfeldman$elm_css$Css$class,
											_user$project$Edit_Style$ArticleSummaryEdit,
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$flexGrow(
													_rtfeldman$elm_css$Css$num(1)),
										...
										_1: {
											...
											_0: A2(
												_rtfeldman$elm_css$Css$class,
												_user$project$Edit_Style$ArticleContentEdit,
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$padding(
														_rtfeldman$elm_css$Css$px(16)),
											...
											_1: {
												...
												_0: A2(
													_rtfeldman$elm_css$Css$class,
													_user$project$Edit_Style$ArticlePreview,
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$width(
															_rtfeldman$elm_css$Css$pct(40)),
												...
												_1: {
													...
													_0: A2(
														_rtfeldman$elm_css$Css$class,
														_user$project$Edit_Style$Separator,
														{
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$width(
													...
													_1: {
														...
														_0: A2(
															_rtfeldman$elm_css$Css$class,
															_user$project$Edit_Style$ButtonList,
															{
																ctor: '::',
																_0: _rtfeldman$elm_css$Css$displayFlex,
																_1: {
																						...
																						_0: _rtfeldman$elm_css$Css_Elements$button(
																							{
																								...
																								_1: {
																									...
																									_0: A3(
																										...
																										_rtfeldman$elm_css$Css$hex('4fc3f7')),
																									_1: {
																										ctor: '::',
																										_0: _rtfeldman$elm_css$Css$hover(
																											{
																											...
																											_1: {
																												...
																												_1: {
																													...
																													_0: _rtfeldman$elm_css$Css$color(
																														_rtfeldman$elm_css$Css$hex('03a9f4')),
																													_1: {
																														ctor: '::',
																														_0: _rtfeldman$elm_css$Css$fontSize(
																															_rtfeldman$elm_css$Css$em(1.3)),
																															...
																															_0: _rtfeldman$elm_css$Css$hover(
																																{
																																	...
																																	_1: {
																																		ctor: '::',
																																		_0: _rtfeldman$elm_css$Css$backgroundColor(
																																			_rtfeldman$elm_css$Css$hex('FDFDFD')),
																																		_1: {
																																			ctor: '::',
																																			_0: _rtfeldman$elm_css$Css$cursor(_rtfeldman$elm_css$Css$pointer),
																																			_1: {
														...
														_1: {
															...
															_0: A2(
																_rtfeldman$elm_css$Css$class,
																_user$project$Edit_Style$Active,
																{
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Css$backgroundColor(
																		_rtfeldman$elm_css$Css$hex('DDD')),
															...
															_1: {
																...
																_0: A2(
																	_rtfeldman$elm_css$Css$class,
																	_user$project$Edit_Style$DeleteModal,
																	{
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Css$displayFlex,
																		_1: {
																															...
																															_1: {
																																...
																																_1: {
																																	...
																																	_0: _rtfeldman$elm_css$Css$children(
																																		{
																																			ctor: '::',
																																			_0: _rtfeldman$elm_css$Css_Elements$i(
																																				{
																																					ctor: '::',
																																					_0: _rtfeldman$elm_css$Css$fontSize(
																...
																_1: {
																	...
																	_0: A2(
																		_rtfeldman$elm_css$Css$class,
																		_user$project$Edit_Style$Hidden,
																		{
																			ctor: '::',
																	...
																	_1: {
																		...
																		_0: A2(
																			_rtfeldman$elm_css$Css$class,
																			_user$project$Edit_Style$Right,
																			{
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$justifyContent(_rtfeldman$elm_css$Css$spaceBetween),
																				_1: {ctor: '[]'}
																		...
																		_1: {
																			...
																			_0: A2(
																				_rtfeldman$elm_css$Css$class,
																				_user$project$Edit_Style$NotSaved,
																				{
																					ctor: '::',
																					_0: _rtfeldman$elm_css$Css$backgroundColor(
																						A4(_rtfeldman$elm_css$Css$rgba, 191, 54, 12, 0.3)),
																					_1: {
																						ctor: '::',
																						_0: A2(
																							...
																							{
																								ctor: '::',
																								_0: _user$project$Edit_Style$Active,
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
																								_0: _rtfeldman$elm_css$Css$backgroundColor(
																									A4(_rtfeldman$elm_css$Css$rgba, 166, 29, 0, 0.2)),
																								_1: {ctor: '[]'}
																							}),
																						_1: {
																							ctor: '::',
																							_0: _rtfeldman$elm_css$Css$hover(
																								{
																									...
																									_0: _rtfeldman$elm_css$Css$important(
																										_rtfeldman$elm_css$Css$backgroundColor(
																											A4(_rtfeldman$elm_css$Css$rgba, 166, 29, 0, 0.3))),
																									_1: {ctor: '[]'}
																								}),
																							_1: {ctor: '[]'}
																						}
...
var _user$project$App_Style$unsetLink = function () {
	var unset = {
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$color(_rtfeldman$elm_css$Css$initial),
		_1: {
			ctor: '::',
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$hover(unset),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$focus(unset),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$active(unset),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$App_Style$SocialIcons = {ctor: 'SocialIcons'};
var _user$project$App_Style$SideBarSection = {ctor: 'SideBarSection'};
var _user$project$App_Style$FloatingSideBar = {ctor: 'FloatingSideBar'};
var _user$project$App_Style$CloseModal = {ctor: 'CloseModal'};
var _user$project$App_Style$LoginModal = {ctor: 'LoginModal'};
var _user$project$App_Style$ButtonLogin = {ctor: 'ButtonLogin'};
var _user$project$App_Style$FormElement = {ctor: 'FormElement'};
var _user$project$App_Style$LoginForm = {ctor: 'LoginForm'};
var _user$project$App_Style$Hidden = {ctor: 'Hidden'};
var _user$project$App_Style$ButtonList = {ctor: 'ButtonList'};
var _user$project$App_Style$Slider = {ctor: 'Slider'};
var _user$project$App_Style$NavBar = {ctor: 'NavBar'};
var _user$project$App_Style$TagLine = {ctor: 'TagLine'};
var _user$project$App_Style$Summary = {ctor: 'Summary'};
var _user$project$App_Style$DashboardArticle = {ctor: 'DashboardArticle'};
var _user$project$App_Style$Article = {ctor: 'Article'};
var _user$project$App_Style$PageAnchor = {ctor: 'PageAnchor'};
var _user$project$App_Style$PageFrame = {ctor: 'PageFrame'};
var _user$project$App_Style$appCss = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'bbs', _p0));
}(
	{
								...
								_1: {
									...
									_1: {
										...
										_0: _rtfeldman$elm_css$Css$backgroundImage(
											_rtfeldman$elm_css$Css$url('/img/fresh_snow.png')),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$color(
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$color(
							A3(_rtfeldman$elm_css$Css$rgb, 60, 60, 60)),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$margin(
								_rtfeldman$elm_css$Css$px(0)),
				...
				_1: {
					...
					_1: {
								...
								_0: _rtfeldman$elm_css$Css$children(
									{
										...
										_0: _rtfeldman$elm_css$Css_Elements$li(
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$listStyleType(_rtfeldman$elm_css$Css$initial),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css_Elements$a(_user$project$App_Style$unsetLink),
							_1: {
								ctor: '::',
								_0: A2(
									_rtfeldman$elm_css$Css$class,
									_user$project$App_Style$PageFrame,
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$backgroundColor(
											_rtfeldman$elm_css$Css$hex('FFF')),
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: A2(_rtfeldman$elm_css$Css$property, 'min-height', 'calc(100vh - 400px)'),
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$top(
																								...
																								_1: {
																									...
																									_1: {
																										...
																										_0: A3(
																											...
																											_rtfeldman$elm_css$Css$px(2),
																											_rtfeldman$elm_css$Css$solid,
																											_rtfeldman$elm_css$Css$hex('004d40')),
																										_1: {
																											ctor: '::',
																											_0: _rtfeldman$elm_css$Css$paddingLeft(
																												_rtfeldman$elm_css$Css$px(24)),
								...
								_1: {
									...
									_0: A2(
										_rtfeldman$elm_css$Css$class,
										_user$project$App_Style$PageAnchor,
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$displayFlex,
											_1: {ctor: '[]'}
									...
									_1: {
										...
										_0: A2(
											_rtfeldman$elm_css$Css$class,
											_user$project$App_Style$DashboardArticle,
											{
												ctor: '::',
																	...
																	_0: _rtfeldman$elm_css$Css$children(
																		{
																			...
																			_1: {
																				...
																				_0: A2(
																					_rtfeldman$elm_css$Css$class,
																					_user$project$App_Style$Summary,
																					{
																						ctor: '::',
																						_0: A2(
																							_rtfeldman$elm_css$Css$padding2,
																				...
																				_1: {
																					...
																					_0: A2(
																						_rtfeldman$elm_css$Css$class,
																						_user$project$App_Style$TagLine,
																						{
																							ctor: '::',
																							_0: _rtfeldman$elm_css$Css$displayFlex,
																							_1: {
										...
										_1: {
											...
											_0: A2(
												_rtfeldman$elm_css$Css$class,
												_user$project$App_Style$CloseModal,
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$width(
														_rtfeldman$elm_css$Css$px(32)),
											...
											_1: {
												...
												_0: A2(
													_rtfeldman$elm_css$Css$class,
													_user$project$App_Style$NavBar,
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$displayFlex,
														_1: {
																			...
																			_0: _rtfeldman$elm_css$Css$children(
																				{
																					...
																					_0: A2(
																						_rtfeldman$elm_css$Css$class,
																						_user$project$App_Style$ButtonList,
																						{
																							ctor: '::',
																							_0: _rtfeldman$elm_css$Css$displayFlex,
																							_1: {
												...
												_1: {
													...
													_0: A2(
														_rtfeldman$elm_css$Css$class,
														_user$project$App_Style$Slider,
														{
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$width(
																_rtfeldman$elm_css$Css$pct(100)),
															_1: {
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Css$backgroundImage(
																			_rtfeldman$elm_css$Css$url('/img/background_rope.jpeg')),
																		_1: {
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$backgroundSize(_rtfeldman$elm_css$Css$cover),
																			_1: {
																				ctor: '::',
																				_0: A2(_rtfeldman$elm_css$Css$property, 'background-position', '50% 60%'),
																				_1: {
																					ctor: '::',
																					_0: _rtfeldman$elm_css$Css$zIndex(
																						_rtfeldman$elm_css$Css$int(1000)),
													...
													_1: {
														...
														_0: A2(
															_rtfeldman$elm_css$Css$class,
															_user$project$App_Style$LoginModal,
															{
																ctor: '::',
																_0: _rtfeldman$elm_css$Css$displayFlex,
																_1: {
														...
														_1: {
															...
															_0: A2(
																_rtfeldman$elm_css$Css$class,
																_user$project$App_Style$LoginForm,
																{
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Css$displayFlex,
																	_1: {
															...
															_1: {
																...
																_0: A2(
																	_rtfeldman$elm_css$Css$class,
																	_user$project$App_Style$FormElement,
																	{
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Css$displayFlex,
																		_1: {
																...
																_1: {
																	...
																	_0: A2(
																		_rtfeldman$elm_css$Css$class,
																		_user$project$App_Style$ButtonLogin,
																		{
																			ctor: '::',
																	...
																	_1: {
																		...
																		_0: A2(
																			_rtfeldman$elm_css$Css$class,
																			_user$project$App_Style$Hidden,
																			{
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$none),
																				_1: {ctor: '[]'}
																		...
																		_1: {
																			...
																			_0: A2(
																				_rtfeldman$elm_css$Css$class,
																				_user$project$App_Style$FloatingSideBar,
																				{
																					ctor: '::',
																					_0: _rtfeldman$elm_css$Css$flexGrow(
																						_rtfeldman$elm_css$Css$num(1)),
																																	...
																																	_0: _rtfeldman$elm_css$Css$children(
																																		{
																																			...
																																			_1: {
																																				...
																																				_0: A2(
																																					_rtfeldman$elm_css$Css$class,
																																					_user$project$App_Style$SideBarSection,
																																					{
																																						ctor: '::',
																																									...
																																									_0: _rtfeldman$elm_css$Css$children(
																																										{
																																											...
																																											_0: A2(
																																												_rtfeldman$elm_css$Css$class,
																																												_user$project$App_Style$SocialIcons,
																																												{
																																													ctor: '::',
																																													_0: _rtfeldman$elm_css$Css$displayFlex,
																																													_1: {
...
var _user$project$App_Style$css = {
	ctor: '::',
	_0: _user$project$App_Style$appCss,
	_1: {
		ctor: '::',
		_0: _user$project$Shared_Style$css,
		_1: {
			ctor: '::',
			_0: _user$project$Edit_Style$css,
			_1: {ctor: '[]'}
		}
	}
};
...
var _user$project$Shared_Markdown$basicOptions = {
	githubFlavored: _elm_lang$core$Maybe$Just(
...
var _user$project$Shared_Markdown$toHtml = A2(
	_evancz$elm_markdown$Markdown$toHtmlWith,
	_user$project$Shared_Markdown$basicOptions,
	{
		ctor: '::',
...
var _user$project$Shared_Icon$icon = function (identifier) {
	return A2(
		_elm_lang$html$Html$i,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(
				A2(_elm_lang$core$Basics_ops['++'], 'fa fa-', identifier)),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'});
};

var _user$project$Edit_View$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('bbsEdit');
var _user$project$Edit_View$id = _user$project$Edit_View$_p0.id;
var _user$project$Edit_View$class = _user$project$Edit_View$_p0.$class;
var _user$project$Edit_View$classList = _user$project$Edit_View$_p0.classList;
var _user$project$Edit_View$articleListItem = F2(
	function (currentId, article) {
		var savedClass = article.saved ? {ctor: '[]'} : {
			ctor: '::',
			_0: _user$project$Edit_Style$NotSaved,
			_1: {ctor: '[]'}
		};
		var activeClass = _elm_lang$core$Native_Utils.eq(article.id, currentId) ? {
			ctor: '::',
			_0: _user$project$Edit_Style$Active,
			_1: {ctor: '[]'}
		} : {ctor: '[]'};
		return A2(
			_elm_lang$html$Html$a,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Edit_Types$SetUrl(
						A2(_elm_lang$core$Basics_ops['++'], 'edit/', article.id))),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Edit_View$class(
							A2(_elm_lang$core$Basics_ops['++'], activeClass, savedClass)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Edit_View$deleteModal = function (model) {
	var classes = {
		ctor: '::',
		_0: _user$project$Edit_Style$DeleteModal,
		_1: function () {
			var _p1 = model.deleteAttempt;
			if (_p1 === true) {
				return {ctor: '[]'};
			} else {
				return {
					ctor: '::',
					_0: _user$project$Edit_Style$Hidden,
					_1: {ctor: '[]'}
				};
			}
		}()
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Edit_View$class(classes),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$Shared_Icon$icon('exclamation-circle'),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Are you sure you want to delete the article'),
								_1: {
									ctor: '::',
									_0: A2(
									...
									_1: {
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'\'',
												A2(_elm_lang$core$Basics_ops['++'], model.article.title, '\'?'))),
										_1: {ctor: '[]'}
									}
								}
							}),
							...
							_0: A2(
								_elm_lang$html$Html$div,
								{
									...
									_0: _user$project$Edit_View$class(
										{
											ctor: '::',
											_0: _user$project$Edit_Style$EditButtons,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_0: _user$project$Edit_View$class(
												{
													ctor: '::',
													_0: _user$project$Edit_Style$ButtonGreen,
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Edit_Types$RemoveArticle),
												_1: {ctor: '[]'}
											}
										},
										{
											ctor: '::',
											_0: _user$project$Shared_Icon$icon('check'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_0: _user$project$Edit_View$class(
													{
														ctor: '::',
														_0: _user$project$Edit_Style$ButtonRed,
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Edit_Types$StopRemoveAttempt),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _user$project$Shared_Icon$icon('times'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _user$project$Edit_View$class(
					{
						ctor: '::',
						_0: _user$project$Edit_Style$Edit,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _user$project$Edit_View$deleteModal(model),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _user$project$Edit_View$class(
								{
									ctor: '::',
									_0: _user$project$Edit_Style$EditNav,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
							...
							_0: A2(
								_elm_lang$html$Html$div,
								{
									...
									_0: _user$project$Edit_View$class(
										{
											ctor: '::',
											_0: _user$project$Edit_Style$ButtonList,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Edit_Types$SetUrl(
													A2(_elm_lang$core$Basics_ops['++'], 'article/', model.article.id))),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _user$project$Shared_Icon$icon('newspaper-o'),
											_1: {
												ctor: '::',
								...
								_0: A2(
										...
										_0: _user$project$Edit_View$class(
											{
												...
												_1: {
													ctor: '::',
													_0: _user$project$Edit_Style$Right,
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Edit_Types$SaveArticle),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _user$project$Shared_Icon$icon('paper-plane-o'),
												_1: {
													ctor: '::',
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _user$project$Edit_View$class(
									{
										ctor: '::',
										_0: _user$project$Edit_Style$EditContainer,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
								...
								_0: A2(
									_elm_lang$html$Html$div,
									{
										...
										_0: _user$project$Edit_View$class(
											{
												ctor: '::',
												_0: _user$project$Edit_Style$SideBar,
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									},
									{
										...
										_0: A2(
											...
											A2(
												_elm_lang$core$List$map,
												_user$project$Edit_View$articleListItem(model.article.id),
												context.articles)),
										_1: {
											ctor: '::',
											_0: A2(
													...
													_0: _user$project$Edit_View$class(
														{
															...
															_1: {
																ctor: '::',
																_0: _user$project$Edit_Style$ModifyButtons,
																_1: {ctor: '[]'}
															}
														}),
													_1: {ctor: '[]'}
												},
												{
													...
													_0: A2(
														_elm_lang$html$Html$button,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(_user$project$Edit_Types$NewArticle),
																_1: {ctor: '[]'}
															}
														},
														{
															ctor: '::',
															_0: _user$project$Shared_Icon$icon('plus'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$button,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_user$project$Edit_Types$AttemptRemoveArticle),
																	_1: {ctor: '[]'}
																}
															},
															{
																ctor: '::',
																_0: _user$project$Shared_Icon$icon('trash-o'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
									...
									_0: A2(
										_elm_lang$html$Html$div,
										{
											...
											_0: _user$project$Edit_View$class(
												{
													ctor: '::',
													_0: _user$project$Edit_Style$ArticleEdit,
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										},
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_0: _user$project$Edit_View$class(
														{
															ctor: '::',
															_0: _user$project$Edit_Style$ArticleTitleEdit,
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_user$project$Edit_Types$TitleChange),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$type_('text'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value(model.article.title),
																_1: {
																	ctor: '::',
												...
												_0: A2(
													_elm_lang$html$Html$span,
													{
														...
														_0: _user$project$Edit_View$class(
															{
																ctor: '::',
																_0: _user$project$Edit_Style$Separator,
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													},
													...
													_0: A2(
														_elm_lang$html$Html$textarea,
														{
															...
															_0: _user$project$Edit_View$class(
																{
																	ctor: '::',
																	_0: _user$project$Edit_Style$ArticleSummaryEdit,
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(_user$project$Edit_Types$SummaryChange),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$value(model.article.summary),
																	_1: {ctor: '[]'}
																}
															}
														},
															...
															_0: A2(
																_elm_lang$html$Html$textarea,
																{
																	...
																	_0: _user$project$Edit_View$class(
																		{
																			ctor: '::',
																			_0: _user$project$Edit_Style$ArticleContentEdit,
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onInput(_user$project$Edit_Types$ContentChange),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$value(model.article.content),
																			_1: {ctor: '[]'}
																		}
																	}
																},
										...
										_0: A2(
											_elm_lang$html$Html$div,
											{
												...
												_0: _user$project$Edit_View$class(
													{
														ctor: '::',
														_0: _user$project$Edit_Style$ArticlePreview,
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(model.article.title),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: _user$project$Shared_Markdown$toHtml(model.article.content),
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
...
var _user$project$App_View$htmlIfEditRoute = F3(
	function (html, $default, model) {
		var _p0 = model.route;
		if (_p0.ctor === 'EditRoute') {
			return html;
		} else {
			return $default;
		}
	});
var _user$project$App_View$presentationTime = function (date) {
	return A2(_mgold$elm_date_format$Date_Format$format, '%e. %B %Y  %H:%M', date);
};
var _user$project$App_View$_p1 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('bbs');
...
var _user$project$App_View$flash = function (flash) {
	var _p2 = function () {
		var _p3 = flash.message;
		switch (_p3.ctor) {
			case 'Info':
				return A2(_NoRedInk$rocket_update$Rocket_ops['=>'], _user$project$Shared_Style$FlashInfo, _p3._0);
			case 'Error':
				return A2(_NoRedInk$rocket_update$Rocket_ops['=>'], _user$project$Shared_Style$FlashError, _p3._0);
			default:
				return A2(_NoRedInk$rocket_update$Rocket_ops['=>'], _user$project$Shared_Style$FlashWarn, _p3._0);
		}
	}();
	var flashTypeClass = _p2._0;
	var msg = _p2._1;
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _user$project$App_View$class(
				{
					ctor: '::',
					_0: flashTypeClass,
					_1: {ctor: '::', _0: _user$project$Shared_Style$Flash, _1: flash.animation.classes}
				}),
			_1: {ctor: '[]'}
		},
		{
...
var _user$project$App_View$dashboardArticle = function (article) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$App_View$class(
				{
					ctor: '::',
					_0: _user$project$App_Style$DashboardArticle,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _user$project$App_View$class(
							{
								ctor: '::',
								_0: _user$project$App_Style$Summary,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(article.summary),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _user$project$App_View$class(
								{
									ctor: '::',
									_0: _user$project$App_Style$TagLine,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_user$project$App_View$presentationTime(article.insertedAt),
												' / by Alpox'))),
									_1: {ctor: '[]'}
								}),
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$span,
									{
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$App_Types$SetUrl(
												A2(_elm_lang$core$Basics_ops['++'], 'article/', article.id))),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _user$project$App_View$dashboardView = function (context) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Latest posts'),
					_1: {ctor: '[]'}
				}),
			_1: A2(_elm_lang$core$List$map, _user$project$App_View$dashboardArticle, context.articles)
		});
};
var _user$project$App_View$articleView = function (article) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$App_View$class(
				{
					ctor: '::',
					_0: _user$project$App_Style$Article,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Shared_Markdown$toHtml(article.content),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$App_View$page = function (model) {
	...
	switch (_p4.ctor) {
		case 'DashboardRoute':
			return _user$project$App_View$dashboardView(model.context);
		case 'ArticleRoute':
			var _p6 = _p4._0;
			var _p5 = A2(_user$project$Shared_List$findById, _p6, model.context.articles);
			if (_p5.ctor === 'Just') {
				return _user$project$App_View$articleView(_p5._0);
			} else {
				return _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'Article with id ',
						A2(_elm_lang$core$Basics_ops['++'], _p6, ' not found.')));
			}
		default:
			return _elm_lang$html$Html$text('Route not found');
	}
};
var _user$project$App_View$loginModal = function (model) {
	var classes = {
		ctor: '::',
		_0: _user$project$App_Style$LoginModal,
		_1: model.showLoginModal ? {ctor: '[]'} : {
			ctor: '::',
			_0: _user$project$App_Style$Hidden,
			_1: {ctor: '[]'}
		}
	};
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$App_View$class(classes),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$button,
				{
					...
					_0: _user$project$App_View$class(
						{
							ctor: '::',
							_0: _user$project$App_Style$CloseModal,
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$App_Types$CloseLoginModal),
						_1: {ctor: '[]'}
					}
				},
				{
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _user$project$App_View$class(
							{
								ctor: '::',
								_0: _user$project$App_Style$LoginForm,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
							...
							_0: A2(
								_elm_lang$html$Html$div,
								{
									...
									_0: _user$project$App_View$class(
										{
											ctor: '::',
											_0: _user$project$App_Style$FormElement,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
									...
									_1: {
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$placeholder('Max'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_user$project$App_Types$SetUsername),
														_1: {ctor: '[]'}
													}
												}
											},
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$placeholder('Secret'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_user$project$App_Types$SetPassword),
															_1: {ctor: '[]'}
														}
													}
												},
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_0: _user$project$App_View$class(
												{
													ctor: '::',
													_0: _user$project$App_Style$ButtonLogin,
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$App_Types$Login),
												_1: {ctor: '[]'}
											}
										},
										{
											ctor: '::',
											_0: _user$project$Shared_Icon$icon('user'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text(' Login'),
												_1: {ctor: '[]'}
...
var _user$project$App_View$navigationBar = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$App_View$class(
				{
					ctor: '::',
					_0: _user$project$App_Style$NavBar,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _user$project$App_View$class(
						{
							ctor: '::',
							_0: _user$project$App_Style$ButtonList,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Shared_Icon$icon('home'),
							_1: {
								ctor: '::',
					...
					model.context.isLoggedIn ? {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$App_Types$SetUrl('edit/')),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _user$project$Shared_Icon$icon('edit'),
								_1: {
									ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$App_Types$Logout),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _user$project$Shared_Icon$icon('arrow-right'),
									_1: {
										ctor: '::',
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$App_Types$ShowLoginModal),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$App_View$sideBar = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$App_View$class(
			{
				ctor: '::',
				_0: _user$project$App_Style$FloatingSideBar,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src('/img/profile.png'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _user$project$App_View$class(
								{
									ctor: '::',
									_0: _user$project$App_Style$SideBarSection,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Alpox'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Full-stack developer'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('and data juggler'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$div,
												{
													...
													_0: _user$project$App_View$class(
														{
															ctor: '::',
															_0: _user$project$App_Style$SocialIcons,
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$href('http://github.com/alpox'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$href('https://ch.linkedin.com/in/elias-bernhaut-10bbb610b'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$src('/img/linkedin.png'),
																		_1: {ctor: '[]'}
																	},
																	{ctor: '[]'}),
																_1: {ctor: '[]'}
