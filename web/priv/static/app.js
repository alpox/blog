...
var _user$project$Article_Types$initialModel = {post: _elm_lang$core$Maybe$Nothing};
var _user$project$Article_Types$Post = F4(
	function (a, b, c, d) {
		return {id: a, title: b, content: c, summary: d};
	});
var _user$project$Article_Types$Model = function (a) {
	return {post: a};
};
...
var _user$project$Dashboard_Types$Model = function (a) {
	return {posts: a};
};
...
var _user$project$Article_Rest$decodeId = function (decodeInt) {
	return _elm_lang$core$Json_Decode$succeed(
		_elm_lang$core$Basics$toString(decodeInt));
};
var _user$project$Article_Rest$postDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Article_Types$Post,
	A2(
		_elm_lang$core$Json_Decode$andThen,
		_user$project$Article_Rest$decodeId,
...
var _user$project$Article_Rest$fetch = function (id) {
	return A2(
		...
		A2(
			...
			A2(_elm_lang$core$Basics_ops['++'], '/api/posts/', id),
...
var _user$project$Dashboard_Rest$fetch = A2(
	_elm_lang$http$Http$send,
	_user$project$Dashboard_Types$Retrieve,
	A2(
		_elm_lang$http$Http$get,
		'/api/posts',
		_elm_lang$core$Json_Decode$list(_user$project$Article_Rest$postDecoder)));
